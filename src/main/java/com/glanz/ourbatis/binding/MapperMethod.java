package com.glanz.ourbatis.binding;
...
public class MapperMethod {
     ...
     * 静态内部类
     *
     * 用于封装sql语句, 设置参数值, 执行该sql语句相关的信息
     * SqlCommon is used to encapsulate SQL statements,
     * set parameter value and execute the information about sql statement
     * */
